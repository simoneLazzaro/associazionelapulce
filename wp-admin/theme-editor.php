...
'content'	=>
	...
	<p>' . __('For PHP files, you can use the Documentation dropdown to select from functions recognized in that file. Look Up takes you to a doggy page with reference material about that particular function.') . '</p>
